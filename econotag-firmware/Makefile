...
TARGETS := econotag_coexisyst_firmware rftest-tx-nocsma rftest-rx-nocsma
...
TARGETS_WITH_ROM_VARS := econotag_coexisyst_firmware rftest-tx-nocsma rftest-rx-nocsma
