...
s32 wldev_iovar_getbuf_bsscfg(
	struct wireless_dev *dev, s8 *iovar_name, void *param, s32 paramlen,
...
extern void dhd_bus_country_set(struct wireless_dev *dev, wl_country_t *cspec);
extern void dhd_bus_band_set(struct wireless_dev *dev, uint band);
extern int wldev_set_country(struct wireless_dev *dev, char *country_code);
...
extern int net_os_wake_lock_timeout_enable(struct wireless_dev *dev, int val);
...
int wldev_get_link_speed(struct wireless_dev *dev, int *plink_speed);

int wldev_get_rssi(struct wireless_dev *dev, int *prssi);

int wldev_get_ssid(struct wireless_dev *dev, wlc_ssid_t *pssid);

int wldev_get_band(struct wireless_dev *dev, uint *pband);

int wldev_set_band(struct wireless_dev *dev, uint band);
