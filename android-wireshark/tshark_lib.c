 ...
 *
 * $Id: tshark.c 36617 2011-04-13 04:53:02Z etxrab $
 *
...
int load_cap_file(capture_file *, char *, int, gboolean, int, gint64);
gboolean process_packet(capture_file *cf, gint64 offset,
...
void open_failure_message(const char *filename, int err,
...
int
tshark_main(int argc, char *argv[])
{
