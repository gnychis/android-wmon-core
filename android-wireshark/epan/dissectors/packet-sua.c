 ...
 *
 * $Id: packet-sua.c 36005 2011-02-18 21:44:06Z gerald $
 *
...
{
  proto_tree_add_item(parameter_tree, hf_sua_ipv6, parameter_tvb, IPV6_ADDRESS_OFFSET, IPV6_ADDRESS_LENGTH, ENC_BIG_ENDIAN);
