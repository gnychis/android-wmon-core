 ...
 *
 * $Id: packet-m3ua.c 35937 2011-02-13 13:56:30Z etxrab $
 *
...
proto_register_m3ua(void)
{
  ...
  static hf_register_info hf[] = {
    ...
    { &hf_protocol_data_si,                 { "SI",                           "m3ua.protocol_data_si",                      FT_UINT8,  BASE_DEC,  VALS(user_identity_values),                   0x0, "Service Indicator",		HFILL } },
